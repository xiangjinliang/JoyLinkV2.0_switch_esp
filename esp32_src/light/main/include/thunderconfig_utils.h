...
#ifndef _THUNDERCONFIG_UTILS_H_
#define _THUNDERCONFIG_UTILS_H_
#include <stdint.h>
...
#define JL_THUNDERCFG_CIDASSII_LEN			4
#define JL_THUNDERCFG_BRANDASSII_LEN		4
#define JL_THUNDERCFG_PUID_LEN 				6
#define JL_THUNDERCFG_MAC_LEN 				6
#define JL_THUNDERCFG_IDENTY_LEN	(JL_THUNDERCFG_PUID_LEN + JL_THUNDERCFG_CIDASSII_LEN + JL_THUNDERCFG_BRANDASSII_LEN + 2*(JL_THUNDERCFG_MAC_LEN))
...
#define JL_THUNDERCFG_RESET_REQUESTAP                   200
#define JL_THUNDERCFG_SENDREQUEST_CYCLE		10
typedef enum {
...
typedef enum {
	...
	JL_THUNDERCFG_STATE_TX_ERROR	= -1,
...
typedef enum {
	...
	JL_THUNDERCFG_STATE_RX_ERROR	= -1,
